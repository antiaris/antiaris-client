    ...
    return /******/ (function (modules) { // webpackBootstrap
        ...
        ([
            ...
            function (module, exports, __webpack_require__) {
                ...
                exports.compose = exports.applyMiddleware = exports.bindActionCreators = exports.combineReducers =
                ...
                if (("development") !== 'production' && typeof isCrushed.name === 'string' && isCrushed.name !==
                    'isCrushed') {
                    (0, _warning2["default"])(
            ...
            function (module, exports, __webpack_require__) {
                ...
                function getUnexpectedStateShapeWarningMessage(inputState, reducers, action) {
                    ...
                    var argumentName = action && action.type === _createStore.ActionTypes.INIT ?
                        'initialState argument passed to createStore' : 'previous state received by the reducer';
                    ...
                    if (!(0, _isPlainObject2["default"])(inputState)) {
                        return 'The ' + argumentName + ' has unexpected type of "' + {}.toString.call(inputState).match(
                ...
                function assertReducerSanity(reducers) {
                    Object.keys(reducers).forEach(function (key) {
                        ...
                        var type = '@@redux/PROBE_UNKNOWN_ACTION_' + Math.random().toString(36).substring(7)
                            .split('').join('.');
                        if (typeof reducer(undefined, {
                            ...
                            throw new Error('Reducer "' + key +
                                '" returned undefined when probed with a random type. ' + (
                                    'Don\'t try to handle ' + _createStore.ActionTypes.INIT +
                ...
                function combineReducers(reducers) {
                    ...
                    return function combination() {
                        ...
                        if (true) {
                            var warningMessage = getUnexpectedStateShapeWarningMessage(state, finalReducers,
                                action);
                            if (warningMessage) {
